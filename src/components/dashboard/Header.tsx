  ...
  return (
    <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
      ...
      <div className="order-2 space-y-2 md:order-1">
        <div className="inline-flex items-center gap-2 rounded-sm bg-indigo-100/80 px-3 py-1 text-xs font-semibold text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-200">
